...
New-NetFirewallRule -DisplayName "Allow InBound  TCP Port 20" -Direction Inbound -LocalPort 20 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "Allow Outbound TCP Port 20" -Direction Outbound -RemotePort 20 -Protocol TCP -Action Allow


New-NetFirewallRule -DisplayName "Allow InBound  TCP Port 21" -Direction Inbound -LocalPort 21 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "Allow Outbound TCP Port 21" -Direction Outbound -RemotePort 21 -Protocol TCP -Action Allow
